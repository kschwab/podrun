...
| `--grace SECONDS`                                                    | Keep-alive idle grace for devcontainer-CLI adoption (default 0 = off; see [Keep-alive & devcontainer adoption](configuration.md#keep-alive--devcontainer-adoption)). Also settable per-start via `podrun start --grace`. |
